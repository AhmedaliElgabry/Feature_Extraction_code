...
ReviewContent_path = arguments[3]
...
#...
book1 = open_workbook(ReviewContent_path)		# Change the path according to the file location
...
df.to_excel(output_path+"/Resulting Features\\Review_Centric_Behavioral_Features.xlsx", index = False)			# Change the path according to the file location
